...
const handleClearClick = () =>{
  ...
  <div className="mb-3" style={{color: props.mode==='dark'?'white':'black'}}>
    <h2>{props.title}</h2>
    <textarea className="form-control" value={Text} onChange={handleOnChange} style={{backgroundColor: props.mode==='dark'?'black':'white',color: props.mode==='dark'?'white':'black'}} id="Textbox" rows="5"></textarea>
